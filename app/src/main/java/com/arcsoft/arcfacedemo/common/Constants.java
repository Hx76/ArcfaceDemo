...
public class Constants {
    ...
    public static final String APP_ID = "EKjMCkqqcibqWbvLUkF5wAeQaxYnfU17mRjTtMDBgMW7";
    public static final String SDK_KEY = "hP1eALkXAXRrDgqYuKgVLqbbMhLGZsuPswRVvwe2pJx";
